# about
a lightweight and efficient implementation of the C-runtime standard library, written in C++20.
...
# compability
behavior of some functions has been changed in favor of the POSIX specification or GNU extensions to make them more sensible or less complex:
function      | note
------------- | ----
